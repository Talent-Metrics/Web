...
export class OrganizationDialogComponent implements OnInit {
  ...
  getErrorMessage(field: string, minlen?: number, maxlen?: number) {
    return this.parent.get(field).hasError('required') ? 'You must enter a value' :
      this.parent.get(field).hasError('minlength') ? `Must be longer than ${minlen} characters` :
        this.parent.get(field).hasError('maxlength') ? `Must be shorter than ${maxlen} characters` :
          '';
  }
  constructor(
